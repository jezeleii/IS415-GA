...
#error was here in the selection

# 4.0 Visualizing Regional Development Indicator
...
We will use [*poly2nb()*](https://r-spatial.github.io/spdep/reference/poly2nb.html) of **spdep** package to compute contiguity weight matrices for the study area. This function builds a neighbours list based on regions with contiguous boundaries.
...
To derive a spatial weight matrix based on Inverse Distance method,
...
# 8.0 Row-standardized Weights Matrix
...
This section focuses on the creation of four different spatial lagged variables, they are:
...
1.  Start by applying a function that will assign a value of 1 per each neigbour – done with lapply.
