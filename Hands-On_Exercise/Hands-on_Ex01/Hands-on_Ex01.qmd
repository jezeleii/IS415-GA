...
```{r}
mpsz = st_read(dsn = "HandsOnExercise/HandsOnEx01/data/geospatial"
...
```{r}
cyclingpath = st_read(dsn = "HandsOnExercise/HandsOnEx01/data/geospatial", layer = "CyclingPathGazette")
```
...
```{r}
preschool = st_read("/Users/jezelei/jezeleii/IS415-GA/HandsOnExercise/HandsOnEx01/data/geospatial/PreSchoolsLocation.kml")
...
```{r}
listings <- read_csv("HandsOnExercise/HandsOnEx01/data/aspatial/listings.csv")
```
